...
const BASE_OSC_PITCH = 0.0;
const BASE_OSC_GAIN = 5;

export class Oscillator {
  public readonly number: number;
  private waveType: any;
  ...
  public selectWaveForm = (waveForm: any) => {
...
export class MasterService {
  ...
  private makeOscillators = (waveTypeIn: any | null): any => {
    // todo: return type, osc type
